...
export const predictionResponseSchema = z.object({ student_id: z.number(), student_name: z.string(), target_year: z.number(), predicted_gpa: z.number(), predictions: z.array(z.object({ subject_name: z.string(), predicted_score: z.number() })) });
